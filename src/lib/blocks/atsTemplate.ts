...
export function createAtsGuideTemplateBlocks(): Block[] {
  return [
    ...
    },
    {
      ...
      type: "statGrid",
      stats: [
        { value: "98%", label: "Fortune 500 companies use ATS", variant: "green" },
        { value: "75%", label: "Resumes rejected before human review", variant: "green" },
        { value: "6 sec", label: "Average time recruiters spend on a resume", variant: "orange" },
      ],
    },
    {
      id: id(),
      type: "atsScoreCard",
      url: "cvjury.com/resume-scanner/result",
      badge: "ILLUSTRATIVE EXAMPLE",
      imageSrc: "",
      imageAlt: "CVJury resume scan result screenshot",
    },
